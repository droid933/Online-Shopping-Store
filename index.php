...
<body>
 ...
 <div class="container">
               ...
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        <!-- Slider 01 -->
                        <li>
                              <h3>High Quality Electronic Devices</h3>
                        ...
                        <!-- Slider 03 -->
                        <li>
                            <h3>We have 99% Availability</h3>
                           <h1>YOU CAN FIND ALL BRANDS</h1>
                             <a  href="#features-sec" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#ln">
                                SIGN IN
                            </a>
                             <a  href="#features-sec" class="btn btn-success btn-lg" data-toggle="modal" data-target="#su">
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO ONLINE SHOOPING STORE <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
          &copy 2021 ONLINE SHOPPING STORE| All Rights Reserved |  <a style="color: #fff" target="_blank"></a>
    </div>
     <!-- FOOTER SECTION END-->
