...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav navbar-right navbar-user">
					...
					<li class="dropdown user-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class='glyphicon glyphicon-shopping-cart'></span> Total Price Ordered: N <?php echo $total; ?> </b></a>
			...
			<div class="alert alert-default" style="color:white;background-color:#04312e">
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> Online-Shopping-Store, Shop now!</h3></center>
        </div>
...
mysql_select_db("Online-Shopping-Store",$query1);
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['item_name']."</textarea>
           ...
           <a class='fancybox-buttons' href='../Admin/item_images/".$query2['item_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['item_name']."'>
					...
					<center><h4> Price: N; ".$query2['item_price']." </h4></center>
...
?>
			...
			<div class="alert alert-default" style="background-color:#04312e;">
                       <p style="color:white;text-align:center;">
                       &copy 2021 Online-Shopping-Store| All Rights Reserved 
	...
	<!-- Mediul Modal -->
        <div class="modal fade" id="setAccount" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-sm">
            <div style="color:white;background-color:#04312e" class="modal-content">
